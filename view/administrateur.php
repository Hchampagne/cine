            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav mr-auto">
                    <li class="nav-item active">
                        <a class="nav-link" href="/cine/view/administrateur.php">Accueil</a>
                    </li>
                    <li class="nav-item active">
                        <a class="nav-link" href="#">uilisateur</a>
                    </li>
                    <li class="nav-item active">
                    ...
                    <li class="nav-item active">
                        <a class="nav-link" href="/cine/controller/deconnexion_ctrl.php">déconnexion</a>
                    </li>
                </ul>
                <div class="connexion">
